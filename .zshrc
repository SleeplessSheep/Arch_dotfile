...
alias guic="nvim ~/.config/hypr/hyprland.conf"
alias vim='nvim'                  # use vim command to invoke nvim
alias vi='nvim'                   # use vi command to invoke nvim
alias fetch='neofetch'            # use fetch command to invoke neofetch
