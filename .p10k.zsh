# Generated by Powerlevel10k configuration wizard on 2025-07-06 at 21:49 HKT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%F{202}'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%F{202}'  # grey foreground
      local      clean='%F{202}'  # grey foreground
      local   modified='%F{202}'  # grey foreground
      local  untracked='%F{202}'  # grey foreground
      local conflicted='%F{202}'  # grey foreground
    fi
